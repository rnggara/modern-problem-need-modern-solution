...
<div class="container">
  ...
  <div itemscope>
      ...
      <div class="inner-content clearfix">
          <div id="question-header" class="grid sm:fd-column" >
              <h1 itemprop="name" class="grid--cell fs-headline1 fl1 ow-break-word mb8"><a href="installing-audiokit-core-with-carthage.html" class="question-hyperlink" style="font-family:'Nunito', sans-serif; font-weight: 600; ">{{$thread->title}}</a></h1>
          ...
          <div class="grid fw-wrap pb8 mb16 bb bc-black-2" style="font-family:'Nunito', sans-serif;">
              <div class="grid--cell ws-nowrap mr16 mb8" title="2020-07-08 15:01:54Z">
                  ...
                  <time itemprop="dateCreated" datetime="2020-07-08T15:01:54">{{date('d F Y', strtotime($thread->created_at))}}</time>
              </div>
          </div>
  ...
  <div id="dfp-isb" class="everyonelovesstackoverflow everyoneloves__inline-sidebar mt24 mx-auto"></div>
              <div class="grid fw-wrap pb8 mb16 bb bc-black-2" style="font-family:'Nunito', sans-serif;">
                  <div class="grid--cell ws-nowrap mr16 mb8" title="2020-07-08 15:01:54Z">
                      <time>{{$countAnswer}}</time>
                      <span class="fc-light mr2">Jawaban</span>
                  </div>
              </div>
              @foreach($answer as $catAnswer)
              <div class="question" data-questionid="62797786" id="question" style="margin-left: 10px">
                  <style>
                      .everyoneloves__top-leaderboard:empty,
                      .everyoneloves__mid-leaderboard:empty,
                      .everyoneloves__bot-mid-leaderboard:empty{
